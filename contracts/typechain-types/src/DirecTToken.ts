...
export interface DirecTTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface DirecTToken extends BaseContract {
  connect(runner?: ContractRunner | null): DirecTToken;
  waitForDeployment(): Promise<this>;

  interface: DirecTTokenInterface;
